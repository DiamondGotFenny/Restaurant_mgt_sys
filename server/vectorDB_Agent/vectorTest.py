...
class VectorStoreAgent:
    ...
    def _load_or_create_vector_store(self) -> Chroma:
        ...
        if os.path.exists(self.persist_directory) and os.listdir(self.persist_directory):
            ...
            if not documents:
                print("No documents found. Please add PDF files to the specified directory.")
    ...
    def _load_pdfs(self) -> List:
        ...
        if not pdf_files:
            print(f"No PDF files found in directory: {self.pdf_directory}")
        ...
        for pdf_file in pdf_files:
            ...
            print(f"Loaded and split {len(split_docs)} documents from {pdf_file}.")
        
        print(f"Total documents loaded and split: {len(documents)}")
